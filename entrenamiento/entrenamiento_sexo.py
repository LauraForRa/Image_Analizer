...
batch_size = 32
epochs = 10
preprocessed_dir = "data_sexo"

# Generador de datos sin augmentación (solo reescalado)
...
assert len(class_names) == 2, f"Se esperaban 2 clases, pero se encontraron: {class_names}"
...
# Entrenamiento (sin class_weight por ahora)
history = modelo.fit(
    train_generator,
...
modelo.save("programa/modelos/modelo_sexo.h5")
